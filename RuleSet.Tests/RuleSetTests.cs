...
namespace RuleSet.Tests
{
	...
	public class RuleSetTestsWithSixGenericInputTypes
	{
		...
		public void TestFirstReturnsFirstResultWhereTheConditionIsMet()
		{
			...
			Assert.That(ruleSet.First(1,2,3,4,5,6), Is.EqualTo("ascending"));
		}
		...
		public void TestFirstReturnsDefaultResultWhereNoConditionIsMet()
		{
			...
			Assert.That(ruleSet.First(5,5,5,5,5,5), Is.EqualTo("default"));
		}
		...
		public void TestAllReturnsAllResultsWhereTheConditionIsMet()
		{
			...
			var results = ruleSet.All(1,2,3,4,5,6);
    ...
    public class RuleSetTestsWithSevenGenericInputTypes
    {
        ...
        public void TestFirstReturnsFirstResultWhereTheConditionIsMet()
        {
            ...
            Assert.That(ruleSet.First(1,2,3,4,5,6,7), Is.EqualTo("ascending"));
        }
        ...
        public void TestFirstReturnsDefaultResultWhereNoConditionIsMet()
        {
            ...
            Assert.That(ruleSet.First(5,5,5,5,5,5,5), Is.EqualTo("default"));
        }
        ...
        public void TestAllReturnsAllResultsWhereTheConditionIsMet()
        {
            ...
            var results = ruleSet.All(1,2,3,4,5,6,7);
    ...
    public class RuleSetTestsWithEightGenericInputTypes
    {
        ...
        public void TestFirstReturnsFirstResultWhereTheConditionIsMet()
        {
            ...
            Assert.That(ruleSet.First(1,2,3,4,5,6,7,8), Is.EqualTo("ascending"));
        }
        ...
        public void TestFirstReturnsDefaultResultWhereNoConditionIsMet()
        {
            ...
            Assert.That(ruleSet.First(5,5,5,5,5,5,5,5), Is.EqualTo("default"));
        }
        ...
        public void TestAllReturnsAllResultsWhereTheConditionIsMet()
        {
            ...
            var results = ruleSet.All(1,2,3,4,5,6,7,8);
    ...
    public class RuleSetTestsWithNineGenericInputTypes
    {
        ...
        public void TestFirstReturnsFirstResultWhereTheConditionIsMet()
        {
            ...
            Assert.That(ruleSet.First(1,2,3,4,5,6,7,8,9), Is.EqualTo("ascending"));
        }
        ...
        public void TestFirstReturnsDefaultResultWhereNoConditionIsMet()
        {
            ...
            Assert.That(ruleSet.First(5,5,5,5,5,5,5,5,5), Is.EqualTo("default"));
        }
